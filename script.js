...
button.addEventListener("click", function(){
    ...
    if (porcentagem >= 10) {
        ...
        resultado = "Hora de ajustar as velas! alguns motivos para baixo engajamento: baixo nivel de conexão com seus viewers; não ter crescido nos últmos 90 dias; conteúdo não agrada seu publico específico. Confira as dicas sobre engajamento.";
        document.querySelector('.img1').style.display = 'none';
        document.querySelector('.img2').style.display = 'none';
